...
# tracker_folder="TrackEvalYulun/data/trackers/mot_challenge/FISHsub-sortma2mh0it007mf10400-train"
...
out = cv2.VideoWriter(os.path.join(tracker_folder, f'outpy_{tracker_folder}_{max_frames}_yolo.mp4'), cv2.VideoWriter_fourcc(*'mp4v'), 10, (frame_width,frame_height))
